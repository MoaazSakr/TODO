...
class _AddTaskScreenState extends State<AddTaskScreen> {
  ...
  final List<SvgPicture> _groupIcons = [
    SvgPicture.asset(AppIcons.jobGroup, width: 24, height: 24),
    SvgPicture.asset(AppIcons.personGroup, width: 24, height: 24),
    SvgPicture.asset(AppIcons.homeGroup, width: 24, height: 24),
  ];
                ...
                DropdownButtonFormField<String>(
                  ...
                  onChanged: (value){
                    setState(() {
                      ...
                      _groupIcons[_groups.indexOf(value!)];
                    });
                  },
                  validator: (value) {
                    if (value == null) {
